...
class args:
    tag = 3240
    auth = True
    url = "wss://api.coinflex.com/v1"  # change URL between STAGE and LIVE
    cookie = 'wBJEyQfkhjqAduUBblNB4GvctDc='  # this is the API key from your CoinFLEX account found in API Details
    id = 1901  # this is user ID for your CoinFLEX account found in API Details
    # phrase = 'Lj/oLFwLs8uvxoL2DL48qRSXySsxSSkukrMnTQ=='  # this is password for your CoinFLEX account found in API Details
    phrase = 'Sy27091513'

# for other requests, please refer to https://github.com/coinflex-exchange/API/blob/master/WEBSOCKET-README.md
request = {
    # "method": "WatchOrders",
    # "base": Assets['XBTDEC']['id'],
    # "counter": Assets['USDTDEC']['id'],
    # "watch": True,
    "method": "GetBalances",
}
